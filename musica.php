  ...
  <head>
    ...
    <nav class="menu">
      ...
      <ul>
        ...
        <li class="menu__musica menuSelected">
    ...
    <main class="mainAcc">
      <div class="containerAcc">
        ...
        <div class="cardProducto Accesorio3">
          <img src="img/producto/dvd.jpg" alt="" />
          <p class="cardProducto__Text">At the gates burns dvd</p>
          <p class="cardProducto__Price">$29.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
              <a href="#" class="agregar">agregar</a>
