...
<html lang="en">
  <head>
    ...
    <title>X3MUSIC - Accesorios</title>
  ...
  <body>
    ...
    <main class="mainAcc">
      <div class="containerAcc">
        <h1>ACCESORIOS</h1>
        <div class="cardProducto Accesorio1">
        ...
        <div class="cardProducto Accesorio2">
        ...
        <div class="cardProducto Accesorio3">
          <img src="img/producto/mousepad.jpg" alt="" />
          <p class="cardProducto__Text">Mousepad marshmello</p>
        ...
        <div class="cardProducto Accesorio3">
          <img src="img/producto/kurt cobain.jpg" alt="" />
          <p class="cardProducto__Text">Funko pop Kurt cobain</p>
          <p class="cardProducto__Price">$16.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
              <a href="#" class="agregar">agregar</a>
        ...
        <div class="cardProducto Accesorio1">
          <img src="img/producto/korn.jpg" alt="" />
          <p class="cardProducto__Text">Llavero KORN</p>
          <p class="cardProducto__Price">$1.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
              <a href="#" class="agregar">agregar</a>
        ...
        <div class="cardProducto Accesorio2">
          <img src="img/producto/funko.jpg" alt="" />
          <p class="cardProducto__Text">Funko pop batman</p>
          <p class="cardProducto__Price">$16.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
        ...
        <div class="cardProducto Accesorio3">
          <img src="img/producto/pantera.png" alt="" />
          <p class="cardProducto__Text">Uñetas pantera</p>
          <p class="cardProducto__Price">$6.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
              <a href="#" class="agregar">agregar</a>
        ...
        <div class="cardProducto Accesorio3">
          <img src="img/producto/bp.jpg" alt="" />
          <p class="cardProducto__Text">Estuche black pink</p>
          <p class="cardProducto__Price">$11.990</p>
          <div class="card__overlay">
            <div class="overlay__text">
              <a href="#" class="ver">Ver mas...</a>
              <a href="#" class="agregar">agregar</a>
