  ...
  <head>
    ...
    <nav class="menu">
      ...
      <ul>
        ...
        <li class="menu__musica">
          <a href="musica.php">Música</a>
        </li>
        <li class="menu__ropa menuSelected"><a href="ropa.php">Ropa</a></li>
    ...
    <main class="mainAcc">
      <div class="containerAcc">
        ...
        <div class="cardProducto Accesorio1">
          <img src="img/producto/linkin hoodie.jpg" alt="" />
          <p class="cardProducto__Text">Hoodie linkin park</p>
          <p class="cardProducto__Price">$44.990</p>
